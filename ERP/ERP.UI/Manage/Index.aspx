                        ...
                        <tr>
                            ...
                            <td align="left" style="vertical-align: text-bottom; position: relative; padding-top: 5px">
                                <table style="width: 303; height: 61;" id="MenuList" trindex="">
                                    ...
                                    <tr>
                                        <td>
                                            <div id="MenuList_1_" style="position: absolute; width: 102px; height: 144px; cursor: pointer;
                                                display: none; margin-top: 10px;" onmouseover="showMenu('ImgMenu1','Images/Menu/Menu_Over_01.png','MenuList_1_')"
                                                onmouseout="hideListMenu('ImgMenu1','Images/Menu/Menu_01.png','MenuList_1_')">
                                                ...
                                                <table id="Menu_11_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_11_').attr('UrlPath'),11,'产品入库')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            产品入库
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_12_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_12_').attr('UrlPath'),12,'入库退货')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            入库退货
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_13_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_13_').attr('UrlPath'),13,'入库记录')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            入库记录
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_14_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_14_').attr('UrlPath'),14,'产品管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            产品管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_15_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_15_').attr('UrlPath'),15,'供应商管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            供应商管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_16_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_16_').attr('UrlPath'),16,'退货记录')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            退货记录
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_2_" style="position: absolute; width: 102px; height: 144px; cursor: pointer;
                                                display: none; margin-top: 10px;" onmouseover="showMenu('ImgMenu2','Images/Menu/Menu_Over_02.png','MenuList_2_')"
                                                onmouseout="hideListMenu('ImgMenu2','Images/Menu/Menu_02.png','MenuList_2_')">
                                                <table style="width: 100%; height: 10px; background-image: url('Images/Menu/MenuList_BG_02.png')">
                                                    <tr>
                                                        <td style="color: white; height: 10px; text-align: center;">
                                                        </td>
                                                ...
                                                <table id="Menu_21_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_21_').attr('UrlPath'),21,'库存查询')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            库存查询
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_22_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_22_').attr('UrlPath'),22,'库存调拨')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            库存调拨
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_23_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_23_').attr('UrlPath'),23,'调拨记录')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            调拨记录
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_24_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_24_').attr('UrlPath'),24,'库存报警')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            库存报警
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_3_" style="position: absolute; width: 102px; height: 144px; margin-top: 10px;
                                                ...
                                                <table id="Menu_31_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_31_').attr('UrlPath'),31,'未发订单')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            未发订单
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_32_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_32_').attr('UrlPath'),32,'已发订单')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            已发订单
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_33_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_33_').attr('UrlPath'),33,'物流管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            物流管理
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_4_" style="position: absolute; width: 102px; height: 144px; margin-top: 10px;
                                                ...
                                                <table id="Menu_41_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_41_').attr('UrlPath'),41,'产品销售')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            产品销售
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_42_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_42_').attr('UrlPath'),42,'代收货款订单审核')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            代收货款订单审核
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_43_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_43_').attr('UrlPath'),43,'代收货款订单查询')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            代收货款订单查询
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_44_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_44_').attr('UrlPath'),44,'订单取消')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            订单取消
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_45_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_45_').attr('UrlPath'),45,'订单查询')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            订单查询
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_46_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_46_').attr('UrlPath'),46,'所有订单')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            所有订单
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_5_" style="position: absolute; width: 102px; height: 144px; margin-top: 10px;
                                                ...
                                                <table id="Menu_51_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_51_').attr('UrlPath'),51,'添加会员')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            添加会员
                                                        </td>
                                                    </tr>
                                                ...
                                                <table id="Menu_52_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_52_').attr('UrlPath'),52,'会员管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            会员管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_53_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_53_').attr('UrlPath'),53,'会员组管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            会员组管理
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_6_" style="position: absolute; width: 102px; height: 144px; margin-top: 10px;
                                                ...
                                                <table id="Menu_61_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_61_').attr('UrlPath'),61,'客户缴款')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            客户缴款
                                                        </td>
                                                    </tr>
                                                ...
                                                <table id="Menu_62_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_62_').attr('UrlPath'),62,'代收货款')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            代收货款
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_63_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_63_').attr('UrlPath'),63,'积分调拨')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            积分调拨
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_64_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_64_').attr('UrlPath'),64,'款项查询')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            款项查询
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_7_" style="position: absolute; width: 102px; height: 144px; margin-top: 10px;
                                                ...
                                                <table id="Menu_71_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_71_').attr('UrlPath'),71,'库存统计')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            库存统计
                                                        </td>
                                                    </tr>
                                                ...
                                                <table id="Menu_72_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_72_').attr('UrlPath'),72,'销售统计')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            销售统计
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_73_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_73_').attr('UrlPath'),73,'进货统计')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            进货统计
                                                        </td>
                                                    </tr>
                                        ...
                                        <td>
                                            <div id="MenuList_8_" style="position: absolute; width: 102px; height: 144px; margin-top: 10px;
                                                ...
                                                <table id="Menu_81_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_81_').attr('UrlPath'),81,'基本信息管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            基本信息管理
                                                        </td>
                                                    </tr>
                                                ...
                                                <table id="Menu_82_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_82_').attr('UrlPath'),82,'员工管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            员工管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_83_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_83_').attr('UrlPath'),83,'仓库管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            仓库管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_84_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_84_').attr('UrlPath'),84,'通知管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            通知管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_85_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_85_').attr('UrlPath'),85,'产品大类管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            产品大类管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_86_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_86_').attr('UrlPath'),86,'产品小类管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            产品小类管理
                                                        </td>
                                                    </tr>
                                                </table>
                                                <table id="Menu_87_" style="width: 100%; height: 30px; background-image: url('Images/Menu/MenuList_BG_02.png');
                                                    display: none">
                                                    <tr onmouseover="changeClassName(this,'Menu_List_Over')" onmouseout="changeClassName(this,'')"
                                                        onclick="execFunUrl($('#Menu_87_').attr('UrlPath'),87,'客户服务管理')">
                                                        <td style="color: white; height: 30px; text-align: center;">
                                                            客户服务管理
                                                        </td>
                                                    </tr>
